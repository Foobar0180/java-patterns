...
class LinePointAdapter implements Iterable<Point> {
...
class AdapterDemo {
    private final static List<VectorObject> vectors = new ArrayList<>(
            Arrays.asList(
    ...
    public static void draw() {
        for (VectorObject vector : vectors) {
            for (Line line : vector) {
                LinePointAdapter adapter = new LinePointAdapter(line);
